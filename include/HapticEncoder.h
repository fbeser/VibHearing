...
namespace vibhearing {
	...
	class HapticEncoder final {
	   public:
		HapticEncoder(MotorDriver& leftMotor, MotorDriver& rightMotor, const RuntimeSettings& settings);
	   ...
	   private:
		...
		void startPattern(AudioEventType type, uint32_t nowMs, float acousticStrength);
