...
namespace vibhearing::sound_features {
	...
	inline float bandMagnitude(const AudioFeatures& features, const FrequencyBand band) {
	...
	inline float spectralCentroidHz(const AudioFeatures& features) {
		constexpr std::array<float, 6> kBandCentersHz{155.0F, 375.0F, 750.0F, 1500.0F, 3000.0F, 6000.0F};
